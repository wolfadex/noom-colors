...
var $author$project$Main$Solid = {$: 'Solid'};
	...
	return _Utils_Tuple2(
		{
			...
			dairy: $elm$core$Maybe$Nothing,
			fireworks: $BrianHicks$elm_particle$Particle$System$init(
				$elm$random$Random$initialSeed(initialSeed)),
			foodStyle: $author$project$Main$Solid,
			gramsPerServing: '0',
			isWholeGrain: false,
...
var $author$project$Main$ParticleMsg = function (a) {
...
var $author$project$Main$subscriptions = function (model) {
	return A3($BrianHicks$elm_particle$Particle$System$sub, _List_Nil, $author$project$Main$ParticleMsg, model.fireworks);
};
var $laserpants$elm_update_pipeline$Update$Pipeline$save = function (model) {
	return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
};
var $author$project$Main$FBlue = {$: 'FBlue'};
var $author$project$Main$FGreen = {$: 'FGreen'};
var $author$project$Main$FRed = {$: 'FRed'};
...
var $author$project$Main$realFromString = function (str) {
	...
	if (_v0.$ === 'Nothing') {
		...
		var i = _v0.a;
		return (i > 0) ? $elm$core$Result$Ok(i) : $elm$core$Result$Err(
			_List_fromArray(
...
var $obiloud$validator_pipeline$Validator$succeed = A2(
	...
	$elm$core$Result$Ok);
var $author$project$Main$calorieValidator = A5(
	$obiloud$validator_pipeline$Validator$required,
	function ($) {
		return $.caloriesPerServing;
	},
	$elm$core$String$isEmpty,
	'Calories per serving is required',
	$obiloud$validator_pipeline$Validator$custom($author$project$Main$realFromString),
	$obiloud$validator_pipeline$Validator$succeed($elm$core$Basics$identity));
var $author$project$Main$gramsValidator = A5(
	$obiloud$validator_pipeline$Validator$required,
	function ($) {
		return $.gramsPerServing;
	},
	$elm$core$String$isEmpty,
	'Grams per serving is required',
	$obiloud$validator_pipeline$Validator$custom($author$project$Main$realFromString),
	$obiloud$validator_pipeline$Validator$succeed($elm$core$Basics$identity));
...
var $author$project$Main$calculateFoodColor = function (model) {
	var _v0 = model.dairy;
	if (_v0.$ === 'Just') {
		switch (_v0.a.$) {
			case 'NonFat':
				var _v1 = _v0.a;
				return $elm$core$Maybe$Just($author$project$Main$Green);
			case 'LowFat':
				var _v2 = _v0.a;
				return $elm$core$Maybe$Just($author$project$Main$Yellow);
			default:
				var _v3 = _v0.a;
		...
		var _v4 = _Utils_Tuple2(
			A2($obiloud$validator_pipeline$Validator$run, $author$project$Main$calorieValidator, model),
			A2($obiloud$validator_pipeline$Validator$run, $author$project$Main$gramsValidator, model));
		if ((_v4.a.$ === 'Ok') && (_v4.b.$ === 'Ok')) {
			var caloriesPerServing = _v4.a.a;
			var gramsPerServing = _v4.b.a;
			var calorieDensity = caloriesPerServing / gramsPerServing;
			return $elm$core$Maybe$Just(
				function () {
					var _v5 = model.foodStyle;
					switch (_v5.$) {
						case 'Solid':
							return model.isWholeGrain ? ((calorieDensity < 2.4) ? $author$project$Main$Green : $author$project$Main$Yellow) : ((calorieDensity < 1.0) ? $author$project$Main$Green : ((calorieDensity < 2.4) ? $author$project$Main$Yellow : $author$project$Main$Red));
						case 'Liquid':
							if (_v5.a.$ === 'RegularLiquid') {
								var _v6 = _v5.a;
								return (calorieDensity < 0.4) ? $author$project$Main$Green : ((calorieDensity < 0.5) ? $author$project$Main$Yellow : $author$project$Main$Red);
							} else {
								return (calorieDensity < 0.4) ? $author$project$Main$Yellow : $author$project$Main$Red;
							}
						default:
							return (calorieDensity < 0.5) ? $author$project$Main$Green : ((calorieDensity < 1.0) ? $author$project$Main$Yellow : $author$project$Main$Red);
					}
				}());
		} else {
			return $elm$core$Maybe$Nothing;
...
var $author$project$Main$Fizzler = function (a) {
	return {$: 'Fizzler', a: a};
};
...
var $author$project$Main$fizzler = function (color) {
	return A2(
			...
			A2(
				...
				$BrianHicks$elm_particle$Particle$init(
					$elm$random$Random$constant(
						$author$project$Main$Fizzler(color))))));
};
...
var $author$project$Main$fireworkAt = F3(
	function (color, x, y) {
		return A2(
...
var $author$project$Main$triggerFireworks = function (model) {
	var thisFoodColorIsGreen = function () {
		var _v0 = $author$project$Main$calculateFoodColor(model);
		if ((_v0.$ === 'Just') && (_v0.a.$ === 'Green')) {
			var _v1 = _v0.a;
			return true;
		} else {
			return false;
	...
	return _Utils_update(
		model,
		{
			fireworks: ((!model.previousFoodColorIsGreen) && thisFoodColorIsGreen) ? A2(
				$BrianHicks$elm_particle$Particle$System$burst,
				A4(
					$elm_community$random_extra$Random$Extra$andThen3,
					$author$project$Main$fireworkAt,
					A2(
						$elm$random$Random$uniform,
						$author$project$Main$FRed,
						_List_fromArray(
							[$author$project$Main$FGreen, $author$project$Main$FBlue])),
					A2($elm_community$random_extra$Random$Float$normal, 300, 100),
					A2($elm_community$random_extra$Random$Float$normal, 300, 100)),
				model.fireworks) : model.fireworks,
...
var $author$project$Main$update = F2(
	function (msg, model) {
		return $laserpants$elm_update_pipeline$Update$Pipeline$save(
			$author$project$Main$triggerFireworks(
				function () {
					switch (msg.$) {
						case 'NoOp':
							return model;
						case 'SetCaloriesPerServing':
							var caloriesPerServing = msg.a;
							return _Utils_update(
								model,
								{caloriesPerServing: caloriesPerServing});
						case 'SetGramsPerServing':
							var gramsPerServing = msg.a;
							return _Utils_update(
								model,
								{gramsPerServing: gramsPerServing});
						case 'SetWholeGrain':
							var isWholeGrain = msg.a;
							return _Utils_update(
								model,
						...
						case 'SetDairy':
							...
							return _Utils_update(
								model,
								{
									dairy: $elm$core$Maybe$Just(dairyFat)
								});
						case 'ClearDairy':
							return _Utils_update(
								model,
						...
						default:
							...
							return _Utils_update(
								model,
								{
									fireworks: A2($BrianHicks$elm_particle$Particle$System$update, inner, model.fireworks)
								});
					}
				}()));
	});
...
var $mdgriffith$elm_ui$Element$layout = $mdgriffith$elm_ui$Element$layoutWith(
	{options: _List_Nil});
var $author$project$Main$Alcohol = {$: 'Alcohol'};
var $author$project$Main$ArtificialSweetners = {$: 'ArtificialSweetners'};
var $author$project$Main$ClearDairy = {$: 'ClearDairy'};
var $author$project$Main$Liquid = function (a) {
	return {$: 'Liquid', a: a};
};
var $author$project$Main$LowFat = {$: 'LowFat'};
var $author$project$Main$NonFat = {$: 'NonFat'};
var $author$project$Main$RegularLiquid = {$: 'RegularLiquid'};
var $author$project$Main$SetCaloriesPerServing = function (a) {
	return {$: 'SetCaloriesPerServing', a: a};
};
var $author$project$Main$SetDairy = function (a) {
	return {$: 'SetDairy', a: a};
};
var $author$project$Main$SetFoodStyle = function (a) {
	return {$: 'SetFoodStyle', a: a};
};
var $author$project$Main$SetGramsPerServing = function (a) {
	return {$: 'SetGramsPerServing', a: a};
};
var $author$project$Main$SetWholeGrain = function (a) {
	return {$: 'SetWholeGrain', a: a};
};
var $author$project$Main$Soda = {$: 'Soda'};
var $author$project$Main$Soup = {$: 'Soup'};
var $author$project$Main$WholeFat = {$: 'WholeFat'};
...
var $author$project$Main$hslString = F3(
...
var $author$project$Main$toHsl = function (color) {
	switch (color.$) {
		case 'FRed':
...
var $author$project$Main$fireworkView = function (particle) {
	...
	var _v1 = $author$project$Main$toHsl(color);
	var hue = _v1.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A3($author$project$Main$hslString, hue, saturation, maxLuminance - (luminanceDelta * (1 - lifetime))))
			]),
		_List_Nil);
};
var $author$project$Main$foodColorToString = function (foodColor) {
	switch (foodColor.$) {
		case 'Green':
			return 'Green';
		case 'Yellow':
...
var $author$project$Main$viewErrors = function (result) {
	if (result.$ === 'Ok') {
		...
		return A2(
			...
			_List_Nil,
			A2($elm$core$List$map, $author$project$Main$viewError, errs));
	}
};
var $author$project$Main$viewModel = function (model) {
	var gramResult = A2($obiloud$validator_pipeline$Validator$run, $author$project$Main$gramsValidator, model);
	var caloriesResult = A2($obiloud$validator_pipeline$Validator$run, $author$project$Main$calorieValidator, model);
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A3(
					...
					$author$project$Main$fireworkView,
					_List_fromArray(
						[
							A2($elm$html$Html$Attributes$style, 'width', '600px'),
							A2($elm$html$Html$Attributes$style, 'height', '600px'),
							A2($elm$html$Html$Attributes$style, 'background-color', '#0F0F0F')
						]),
					model.fireworks)),
				A2(
				$mdgriffith$elm_ui$Element$row,
					...
					[
							...
							]),
						{
							label: A2(
								...
								_List_Nil,
								$mdgriffith$elm_ui$Element$text('Dairy Fat?: ')),
							onChange: $author$project$Main$SetDairy,
							options: _List_fromArray(
								[
									A2(
									$mdgriffith$elm_ui$Element$Input$option,
									$author$project$Main$NonFat,
									$mdgriffith$elm_ui$Element$text('Non-Fat')),
									A2(
									$mdgriffith$elm_ui$Element$Input$option,
									$author$project$Main$LowFat,
									$mdgriffith$elm_ui$Element$text('Low Fat')),
									A2(
									$mdgriffith$elm_ui$Element$Input$option,
									$author$project$Main$WholeFat,
									$mdgriffith$elm_ui$Element$text('Whole Fat'))
								]),
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$Background$color(
								A3($mdgriffith$elm_ui$Element$rgb, 0, 1, 0.8)),
								$mdgriffith$elm_ui$Element$centerY
							]),
						{
							label: $mdgriffith$elm_ui$Element$text('Not Dairy'),
							onPress: $elm$core$Maybe$Just($author$project$Main$ClearDairy)
						})
					])),
				function () {
				var _v0 = model.dairy;
					...
					return A2(
							...
							]),
						{
							label: A2(
								...
								_List_Nil,
								$mdgriffith$elm_ui$Element$text('Food Style')),
							onChange: $author$project$Main$SetFoodStyle,
							options: _List_fromArray(
								[
									A2(
									$mdgriffith$elm_ui$Element$Input$option,
									$author$project$Main$Solid,
									$mdgriffith$elm_ui$Element$text('Solid')),
									A2(
									$mdgriffith$elm_ui$Element$Input$option,
									$author$project$Main$Liquid($author$project$Main$RegularLiquid),
									$mdgriffith$elm_ui$Element$text('Liquid - Regular')),
									A2(
									$mdgriffith$elm_ui$Element$Input$option,
									$author$project$Main$Liquid($author$project$Main$Soda),
									$mdgriffith$elm_ui$Element$text('Liquid - Soda')),
									A2(
									$mdgriffith$elm_ui$Element$Input$option,
									$author$project$Main$Liquid($author$project$Main$ArtificialSweetners),
									$mdgriffith$elm_ui$Element$text('Liquid - Artificial Sweetners')),
									A2(
									$mdgriffith$elm_ui$Element$Input$option,
									$author$project$Main$Liquid($author$project$Main$Alcohol),
									$mdgriffith$elm_ui$Element$text('Liquid - Alcohol')),
									A2(
									$mdgriffith$elm_ui$Element$Input$option,
									$author$project$Main$Soup,
									$mdgriffith$elm_ui$Element$text('Soup'))
								]),
							selected: $elm$core$Maybe$Just(model.foodStyle)
						});
				}
			}(),
				function () {
							...
							[
								...
								_List_Nil,
								{
									label: A2(
										$mdgriffith$elm_ui$Element$Input$labelAbove,
										_List_Nil,
										$mdgriffith$elm_ui$Element$text('Calories per Serving')),
									onChange: $author$project$Main$SetCaloriesPerServing,
									placeholder: $elm$core$Maybe$Nothing,
									text: model.caloriesPerServing
								}),
								$author$project$Main$viewErrors(caloriesResult)
							]));
				}
			}(),
				function () {
							...
							[
								...
								_List_Nil,
								{
									label: A2(
										$mdgriffith$elm_ui$Element$Input$labelAbove,
										_List_Nil,
										$mdgriffith$elm_ui$Element$text('Grams per Serving')),
									onChange: $author$project$Main$SetGramsPerServing,
									placeholder: $elm$core$Maybe$Nothing,
									text: model.gramsPerServing
								}),
								$author$project$Main$viewErrors(gramResult)
							]));
				}
			}(),
				function () {
						...
						return A2(
							...
							_List_Nil,
							{
								...
								label: A2(
									$mdgriffith$elm_ui$Element$Input$labelAbove,
									_List_Nil,
									$mdgriffith$elm_ui$Element$text('Is Whole Grain?')),
								onChange: $author$project$Main$SetWholeGrain
							});
					} else {
						return $mdgriffith$elm_ui$Element$none;
					}
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('Your food is: '),
						function () {
						var _v5 = $author$project$Main$calculateFoodColor(model);
						if (_v5.$ === 'Nothing') {
							return $mdgriffith$elm_ui$Element$text('Unknown');
						} else {
							var foodColor = _v5.a;
							return A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[
										...
										function () {
											switch (foodColor.$) {
												case 'Green':
													return A3($mdgriffith$elm_ui$Element$rgb, 0, 1, 0);
												case 'Yellow':
													return A3($mdgriffith$elm_ui$Element$rgb, 1, 1, 0);
												default:
													return A3($mdgriffith$elm_ui$Element$rgb, 1, 0, 0);
											}
										}())
									]),
								$mdgriffith$elm_ui$Element$text(
									$author$project$Main$foodColorToString(foodColor)));
						}
					}()
					]))
			]));
